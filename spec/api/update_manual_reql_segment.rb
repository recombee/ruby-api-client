...
shared_examples 'update manual reql segment' do
include_context 'set environment'

  it 'updates manual ReQL segment' do
    ...
    resp = @client.send(req)
    req = described_class.new('seg1','first-segment','\'str_property\' == null',{'title' => 'Updated Segment'})
    resp = @client.send(req)
  end
